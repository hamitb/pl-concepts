...
exampleTree3 = Root [Subword "Pa" [Subword "m" [Word "", Word "t"],Word "rk", Word "ge"]]
exampleTree4 = Subword "Pa" [Subword "rk" [Word "yeri", Word "zamani"], Word "zar"]
exampleTree5 = Root [Subword "Ca" [Subword "n" [Word "", Word "teen"], Word "ptain", Subword "r" [Word "", Subword "r" [ Subword "ie" [Word "d", Word "s"], Word "y"]]], Subword "He" [Word "ck", Subword "l" [Word "lo", Subword "p" [Word "", Subword "e" [Word "d", Word "r"],Word "ing"]]]]
...
putRemainder :: [WordTree] -> String -> [WordTree]
putRemainder [] s = []
putRemainder ((Word x):ys) s = (Word (s++x)) : putRemainder ys s
putRemainder ((Subword x xs):ys) s = (Subword (s++x) xs) : putRemainder ys s
